...
namespace DynamicProxyTutorial03
{
    ...
    public class SimpleProxyGenerationHook : IProxyGenerationHook
    {
        ...
        {
            return methodInfo.IsSpecialName && methodInfo.Name.StartsWith("set_");// && typeof(IDDSObject).IsAssignableFrom(type);
        }
    }
    ...
    public class DDSProxySink : StandardInterceptor
    {
        ...
        protected override void PerformProceed(IInvocation invocation)
        {
            ...
            if (!String.IsNullOrWhiteSpace(domain))
            {
                ...
                Console.WriteLine(">>> INSIDE THE ENGINE : The value to be set is: " + invocation.Arguments[0]);
                invocation.Proceed();
            }
        }
    }
