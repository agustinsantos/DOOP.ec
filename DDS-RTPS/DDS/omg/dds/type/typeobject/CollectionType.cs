...
namespace org.omg.dds.type.typeobject
{
    ...
    [Nested]
    public interface CollectionType : Type
    {
    ...
    public sealed class CollectionTypeMemberId
    {
        // -----------------------------------------------------------------------
        // Constants
        // -----------------------------------------------------------------------

        public const long UNBOUNDED_COLLECTION = 0;
        public const int ELEMENT_TYPE_COLLECTIONTYPE_MEMBER_ID = 100;



        // --- Constructor: --------------------------------------------------
        private CollectionTypeMemberId()
        {
            // empty
        }
    }
