...
{
    class PubSubExample09 : ExampleApp
    {
        public override void RunExample(string[] args)
        {
            ...
            dpqMod.SetKind(LivelinessQosPolicyKind.MANUAL_BY_PARTICIPANT);
            ...
            dsqMod.SetKind(LivelinessQosPolicyKind.MANUAL_BY_PARTICIPANT);
