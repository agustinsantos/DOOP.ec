...
{
    class PubSubExample06 : ExampleApp
    {
        public override void RunExample(string[] args)
        {
            ...
            dpqMod.SetKind(DestinationOrderQosPolicyKind.BY_RECEPTION_TIMESTAMP);
            ...
            dsqMod.SetKind(DestinationOrderQosPolicyKind.BY_RECEPTION_TIMESTAMP);
