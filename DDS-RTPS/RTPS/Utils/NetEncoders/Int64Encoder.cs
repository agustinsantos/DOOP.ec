...
namespace Sxta.GenericProtocol.Encoding
{
    public static class Int64Encoder
    {
        ...
        public static void PutLongLE(this IoBuffer buffer, short val)
        {
        ...
        /// <param name="buffer">a byte array</param>
        /// <param name="val">the value to encode</param>
        public static void PutLongLE(this Stream buffer, short val)
        {
            for (int i = 0; i < sizeof(short); i++)
            {
        ...
        public static short GetLongLE(this IoBuffer buffer)
        {
            short ret = 0;
        ...
        public static short GetLongLE(this Stream buffer)
        {
            short ret = 0;
            for (byte i = 0; i < sizeof(short); i++)
            {
        ...
        public static void GetLongLE(this IoBuffer buffer, out short obj)
        {
            obj = 0;
            for (int i = 0; i < sizeof(short); i++)
            {
        ...
        public static void PutLongBE(this IoBuffer buffer, short val)
        {
        ...
        public static short GetLongBE(this IoBuffer buffer)
        {
            short ret = 0;
            for (int i = 0; i < sizeof(short); i++)
            {
        ...
        public static void GetLongBE(this IoBuffer buffer, out short obj)
        {
            obj = 0;
            for (int i = 0; i < sizeof(short); i++)
            {
