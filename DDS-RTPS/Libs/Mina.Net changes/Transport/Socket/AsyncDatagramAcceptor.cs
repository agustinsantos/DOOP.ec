...
namespace Mina.Transport.Socket
{
    ...
    public partial class AsyncDatagramAcceptor : AbstractIoAcceptor, IDatagramAcceptor, IoProcessor<AsyncDatagramSession>
    {
        ...
        protected readonly IdleStatusChecker _idleStatusChecker;
        private Boolean _disposed;
        private IoSessionRecycler _sessionRecycler = DefaultRecycler;
        protected readonly Dictionary<EndPoint, SocketContext> _listenSockets = new Dictionary<EndPoint, SocketContext>();
        ...
        internal protected partial class SocketContext
        {
